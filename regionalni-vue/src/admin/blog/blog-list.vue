            ...
            <tr v-for="article in articles" :key="article.id">
              ...
              <td data-label="Szczegóły">
                <svg
                  ...
                  @click="redirectToAddContent(article.slug)"
                >
                  <path
                    d="M9 1L9 16"
                    stroke=""
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  @click="redirectToEditPage(article.slug)"
                >
                  <circle
                    cx="8"
                    cy="2"
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  @click="showConfirmation(article.slug)"
                >
                  <path
      ...
      <div class="confirmation-main">
        ...
        <div class="confirmation-bottom">
          ...
          <div class="confirmation-buttons">
            ...
            <button class="confirmation-btn" @click="deleteBlogArticle">
              Usuń
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    fetchData() {
      axios
        .get("http://localhost:8000/blog-list")
        .then((response) => {
    ...
    deleteBlogArticle() {
      axios
        .delete(
          `http://localhost:8000/blog-delete-article/${this.selectedSlug}`
        )
        .then((response) => {
          this.fetchData();
