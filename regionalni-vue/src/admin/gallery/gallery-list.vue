            ...
            <tr v-for="gallery in galleries" :key="gallery.id">
              ...
              <td data-label="Szczegóły">
                <svg
                  ...
                  @click="redirectToGalleryCollectionList(gallery.slug)"
                >
                  <circle
                    cx="8"
                    cy="2"
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  @click="showConfirmation(gallery.slug)"
                >
                  <path
...
export default {
  ...
  methods: {
    ...
    redirectToGalleryCollectionList(slug) {
      this.$router.push(`/galeria-lista-zdjecia/${slug}`);
    },
    ...
    deleteGallery() {
      axios
        .delete(`http://localhost:8000/gallery-delete/${this.selectedSlug}`)
        .then((response) => {
          this.fetchGalleries();
